...
public class Product {
    ...
    private boolean maintainanceCerti;
     ...
     public Product( String brand, int manufacturedYear, int minSeats, int maxSeats, int serialNumber, String modelNumber, String availableCity, boolean available, boolean maintenanceCerti) {
