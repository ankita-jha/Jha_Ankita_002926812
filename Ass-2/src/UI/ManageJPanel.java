...
//To change body of generated methods, choose Tools | Templates.
    ...
    ManageJPanel(JPanel rightJPanel, ProductCatalog uberCatalog) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnSearchBrand.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnManuYear.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnSerialNumber.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnModelNumber.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnAvailCity.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnAvailStatus.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnMainCerti.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
        ...
        btnMinMax.setFont(new java.awt.Font("Calibri", 1, 13)); // NOI18N
    ...
    private void btnSearchBrandActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchBrandActionPerformed
        ...
        ArrayList<Product> result = uberCatalog.searchBrand1(txtField.getText(), uberCatalog.getUberList());
        if (result.size() == 0){
    ...
    private void btnManuYearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManuYearActionPerformed
        ...
        return;
         ...
         {
            ArrayList<Product> result = uberCatalog.searchManuYear(txtField.getText(), uberCatalog.getUberList());
            TableJPanel panel = new TableJPanel(rightJPanel, result, uberCatalog);
            rightJPanel.add("TableJPanel", panel);
            CardLayout layout = (CardLayout) rightJPanel.getLayout();
            layout.next (rightJPanel);
...
/**/
    private void btnSerialNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSerialNumberActionPerformed
        ...
        return;
         ...
         {
            ArrayList<Product> result = uberCatalog.searchSerialNumber(txtField.getText(),uberCatalog.getUberList());
            TableJPanel panel = new TableJPanel(rightJPanel, result, uberCatalog);
            rightJPanel.add("TableJPanel", panel);
            CardLayout layout = (CardLayout) rightJPanel.getLayout();
            layout.next (rightJPanel);
    ...
    private void btnModelNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModelNumberActionPerformed
        // TODO add your handling code here:
        ArrayList<Product> result = uberCatalog.searchModelNumber(txtField.getText(),uberCatalog.getUberList());
        if (result.size() == 0)
        {
    ...
    private void btnAvailCityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvailCityActionPerformed
        // TODO add your handling code here:
        ArrayList<Product> result = uberCatalog.searchAvailCity(txtField.getText(), uberCatalog.getUberList());
        if (result.size() == 0){
    ...
    private void btnAvailStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvailStatusActionPerformed
        ...
        */
        ...
        return;
         ...
         {
            ArrayList<Product> result = uberCatalog.searchAvailStatus(txtField.getText(), uberCatalog.getUberList());
            TableJPanel panel = new TableJPanel(rightJPanel, result, uberCatalog);
            rightJPanel.add("TableJPanel", panel);
            CardLayout layout = (CardLayout) rightJPanel.getLayout();
            layout.next (rightJPanel);
    ...
    private void btnMainCertiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMainCertiActionPerformed
       ...
       {
           ArrayList<Product> result = uberCatalog.searchMainCerti(txtField.getText(), uberCatalog.getUberList());
            TableJPanel panel = new TableJPanel(rightJPanel, result, uberCatalog);
            rightJPanel.add("TableJPanel", panel);
            CardLayout layout = (CardLayout) rightJPanel.getLayout();
            layout.next (rightJPanel);
    ...
    private void btnMinMaxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMinMaxActionPerformed
       ...
       */
       ArrayList<Product> result = uberCatalog.searchSeatsAvail(minSeats , maxSeats, uberCatalog.getUberList());
    ...
    private void btnFirstAvailCarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFirstAvailCarActionPerformed
        // TODO add your handling code here:
            ...
            ArrayList<Product> result = uberCatalog.searchFirstAvailUber(txtField.getText(), uberCatalog.getUberList());
            TableJPanel panel = new TableJPanel(rightJPanel, result, uberCatalog);
            rightJPanel.add("TableJPanel", panel);
            CardLayout layout = (CardLayout) rightJPanel.getLayout();
            layout.next (rightJPanel);
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        {
            Product uber = (Product) tblDetails.getValueAt((selectedRow), 0);
    ...
    void populateTable(ProductCatalog uberList, String all) {
         //To change body of generated methods, choose Tools | Templates.
    ...
    private void populateTable1(ArrayList<Product> uberList) {
         //To change body of generated methods, choose Tools | Templates.
         DefaultTableModel dtm = (DefaultTableModel) tblDetails.getModel();
            dtm.setRowCount(0);
            for (Product uber : uberCatalog.getUberList())
